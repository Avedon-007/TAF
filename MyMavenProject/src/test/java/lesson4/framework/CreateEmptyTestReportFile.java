...
// - Create clean Excel file with the same number of sheets as in a file with test cases
// - Copy the contents of a test cases in an empty file
// - Now have a working file for report
